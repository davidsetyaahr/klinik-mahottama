        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered>'        
                        <tr><td width='200'>ID Dokter <?php echo form_error('kode_dokter') ?></td><td><input type="text" class="form-control" name="kode_dokter" id="kode_dokter" placeholder="ID Dokter Auto Number" readonly="true" value="<?php echo $kode_dokter; ?>" /></td></tr>

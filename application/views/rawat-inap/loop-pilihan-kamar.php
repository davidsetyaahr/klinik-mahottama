...
<br>
    ...
    <div class="col-md-2">
        <?php echo form_input(array('id'=>'harga_kamar','name'=> isset($selected) ? 'old_harga_kamar[]' : 'harga_kamar[]','type'=>'text','value'=>isset($selected) ? $selected['value']->biaya_per_hari : '','class'=>'form-control harga', 'readonly'=>'readonly','placeholder'=>'Harga Kamar','style'=>'text-align:left;'));?>
    </div>
    <div class="<?= $no!=0 ? 'col-md-2' : 'col-md-3' ?>">  
        <?php echo form_input(array('id'=>'total_harga','name'=>  isset($selected) ? 'old_subtotal_kamar[]' : 'subtotal_kamar[]','type'=>'text','value'=>isset($selected) ? $selected['value']->jml_hari * $selected['value']->biaya_per_hari  :'','class'=>'form-control subtotal', 'readonly'=>'readonly','placeholder'=>'Sub Total','style'=>'text-align:left;'));?>
    <!--  -->
    </div>
    <?php 
        if($no!=0){

...
<br>
    ...
    <div class="col-md-2">
    <?php echo form_input(array('id'=>'biaya','name'=> isset($selected) ? 'old_biaya[]' : 'biaya[]','type'=>'text','value'=>isset($selected) ? $selected->biaya : '','class'=>'form-control biaya', 'readonly'=>'readonly','placeholder'=>'Harga Biaya','style'=>'text-align:left;'));?>    
    <!-- <br> -->
    </div>
    <div class="<?= $no!=0 ? 'col-md-2' : 'col-md-3' ?>">  
        <?php echo form_input(array('id'=>'total_biaya','name'=> isset($selected) ? 'old_subtotal_biaya[]' : 'subtotal_biaya[]','type'=>'text','value'=>isset($selected) ? $selected->biaya * $selected->jumlah : '','class'=>'form-control total_biaya', 'readonly'=>'readonly','placeholder'=>'Sub Total','style'=>'text-align:left;'));?>
    <!--  -->
    </div>
    <?php 
        if($no!=0){

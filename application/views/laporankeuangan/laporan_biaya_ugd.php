            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">LAPORAN BIAYA UGD</h3>
                    </div>
                    ...
                    <div class="box-body">
                		...
                		<?php echo anchor(site_url('laporankeuangan/excel_ugd/'.$_GET['dari'].'_'.$_GET['sampai']),'<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "json_biaya_ugd/<?php echo $_GET['dari'].'_'.$_GET['sampai'];?>", "type": "POST"},
            columns: [
                {
                    "data": "id_transaksi",
                    "orderable": false

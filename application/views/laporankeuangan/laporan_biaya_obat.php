            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">LAPORAN TRANSAKSI OBAT</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" id="div_tombol" style="display:none;">
							...
							<div class="col-sm-4"><div align="right"><button type="submit" class="btn btn-success"><i class="fa fa-search"></i> Tampilkan</button></div></div>
                        </div>
                        <?php echo form_close();?>
<?php 
if($id_klinik != ''){
...
if($id_klinik != ''){
    if($rekap_laporan == 1){
?>
            ajax: {"url": "json_biaya_obat/<?php echo $rekap_laporan.'_'.$filter_tanggal.'_'.$id_klinik;?>", "type": "POST"},
<?php
    } else if ($rekap_laporan == 2) {
?>
            ajax: {"url": "json_biaya_obat/<?php echo $rekap_laporan.'_'.$filter_bulan.'_'.$id_klinik;?>", "type": "POST"},
<?php
    } else if ($rekap_laporan == 3) {
?>
            ajax: {"url": "json_biaya_obat/<?php echo $rekap_laporan.'_'.$filter_tahun.'_'.$id_klinik;?>", "type": "POST"},
<?php
    }
}
?>

        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered>'        
                       ...
                       <tr><td width='200'>NIK <?php echo form_error('nik') ?></td><td><input type="text" class="form-control" name="nik" id="nik" placeholder="Nama Pegawai" value="<?php echo $nik; ?>" /></td></tr>
                       <tr><td width='200'>Tanggal Lahir <?php echo form_error('tanggal_lahir') ?></td><td><input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="Nama Pegawai" value="<?php echo $tanggal_lahir; ?>" /></td></tr>
                    ...
                    <tr><td width='200'>Pelatihan Atau Diklat <?php echo form_error('pelatihan') ?></td><td><input type="text" class="form-control" name="pelatihan" id="pelatihan" placeholder="Pelatihan atau Diklat Yang Pernah Diikuti" value="<?php echo $pelatihan; ?>" /></td></tr>
                    ...
                    <tr><td width='200'>Nilai Index <?php echo form_error('nilai_index') ?></td><td><input type="number" class="form-control" name="nilai_index" id="nilai_index" placeholder="Nilai Index" value="<?php echo $nilai_index; ?>" /></td></tr>

        ...
        <div class="box box-warning box-solid">
            ...
            <input type="hidden" name="id_jenis_operasi" value="<?= $id_jenis_operasi  ?>">
                <table class='table table-bordered'>       
                        ...
                        <tr><td width='200'>Biaya Ok <?php echo form_error('biaya_ok') ?></td><td><input type="number" class="form-control" name="biaya_ok" id="biaya_ok" placeholder="Biaya Ok" value="<?php echo $biaya_ok; ?>" /></td></tr>

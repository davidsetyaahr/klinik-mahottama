            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    <div class="box-header">
                        <h3 class="box-title">KELOLA RUANGAN OPERASI</h3>
                    </div>
                    <div class="box-body">
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md-4">
                                <?php echo anchor(site_url('ruangan_operasi/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "ruangan_operasi/json", "type": "POST"},
            columns: [
                {
                    "data": "id",
                    "orderable": false
